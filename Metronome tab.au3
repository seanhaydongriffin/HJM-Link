...
Func Metronome_tab_setup()
	...
	$metronome_periods_listview = 												GUICtrlCreateListViewEx(30, 150, 160, 120, "Period", 90, "GUID", 160)
	GUICtrlCreateGroupEx  ("Quarterly Priorities", 240, 120, 500, 160)
	$metronome_quarterly_priorities_listview = 									GUICtrlCreateListViewEx(260, 150, 460, 120, "Title", 150, "Status", 50, "Order", 50, "GUID", 300)
	GUICtrlCreateGroupEx  ("Action Items", 20, 300, 720, 210)
	$metronome_action_items_listview = 											GUICtrlCreateListViewEx(40, 330, 680, 120, "Text", 250, "Due Date", 100, "Done", 50, "Order", 50, "GUID", 300)
